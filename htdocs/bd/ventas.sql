...
GRANT EXECUTE ON PROCEDURE ventas.subir_imagen TO 'tu_usuario'@'localhost';
GRANT EXECUTE ON PROCEDURE ventas.obtener_imagen TO 'tu_usuario'@'localhost';
GRANT EXECUTE ON PROCEDURE ventas.eliminar_imagen TO 'tu_usuario'@'localhost';
GRANT EXECUTE ON PROCEDURE ventas.obtener_siguiente_id_imagen TO 'tu_usuario'@'localhost';
GRANT EXECUTE ON PROCEDURE ventas.reorganizar_ids_imagenes TO 'tu_usuario'@'localhost';
