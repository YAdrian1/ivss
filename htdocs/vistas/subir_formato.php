...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $sql = "INSERT INTO imagenes_subidas (id_usuario, nombre, imagen_data, tipo_imagen, extension, fecha_subida) VALUES (?, ?, ?, ?, ?, NOW())";
        $stmt = mysqli_prepare($conexion, $sql);

        // Leer el contenido del archivo
        $contenidoArchivo = file_get_contents($rutaDestino);

        mysqli_stmt_bind_param($stmt, "issss", $_SESSION['iduser'], $nombre, $contenidoArchivo, $tipoArchivo, $extension);
