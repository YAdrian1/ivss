...
<div class="form-group">
    ...
    <input type="text" id="searchInput" class="form-control" placeholder="Buscar por nombre o Cedula" onkeyup="filterTable()">

</div>


<div class="table-responsive" style="max-height: 402px; overflow-y: auto;"> <!-- Ajusta la altura máxima aquí -->

    <table class="table table-hover table-condensed table-bordered" id="expedientesTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;"><?php echo htmlspecialchars($row['nombre']); ?></td>

                <td style="text-align: center;"><?php echo htmlspecialchars($row['apellido']); ?></td>

                <td>

                    <div class="btn-group" role="group">

                        <button style="margin-right: 2px; margin-left:5%;" class="btn btn-success btn-sm" 
                        ...
                        <button style="margin-right: 2px;" class="btn btn-primary btn-sm" 
                        ...
                        <button style="margin-right: 2px;" class="btn btn-danger btn-sm" 
                ...
                <form id="formAgregarImagenes" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="categoria" name="categoria" required>
                            ...
                            <option value="sintesis_curricular">Sintesis curricular</option>
                        </select>
                    </div>
                    <div class="form-group">
...
function filterTable() {
    ...
    for (let i = 1; i < tr.length; i++) { // Comienza desde 1 para omitir el encabezado
        ...
        const tdApellido = tr[i].getElementsByTagName("td")[1];
